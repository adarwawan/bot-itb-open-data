...
class DataExtractor(object):
    ...
    def __init__(self):
        ...
        self.Cell = namedtuple('Cell', ['text', 'rowspan'], verbose=True)
        self.Row = namedtuple('Row', ['list_of_cells', 'rowclass'], verbose=True)
    ...
    def construct_key(self, header_matrix, header_list):
        # TODO: handle table with repetitive column name
        keys = []
        # print "header matrix %s " % header_matrix
        # print "header list %s " % header_list
        # print "header matrix[0] len %s " % len(header_matrix[0])
    ...
    def extract_data(self, a_table):
        ...
        return out_json
        # print_to_file('test.txt', json.dumps(out_json))
...
path_exception_dir = "Exceptions/"
path_extracts_dir = "Extracts/parsed-3/"

# for file in os.listdir(path_html_dir):
#     current = os.path.join(path_html_dir, file)
#     checkfirst = os.path.join(path_extracts_dir, file+".txt")
#     if (isfile(current) and not os.path.exists(checkfirst)):
#         current_file_name = basename(current)
#         for file_2 in os.listdir(path_features_dir):
#             current_2 = os.path.join(path_features_dir, file_2)
#             if (isfile(current_2) and (current_file_name in basename(current_2))):
#                 try:
#                     de = DataExtractor()
#                     de.extract_table(current, current_2)
#                 except IndexError as err:
#                     print "Index error %s" % err
#                     src = current
#                     # dst = os.path.join(path_exception_dir+"IndexError\\",basename(current))
#                     dst = os.path.join(path_exception_dir+"parsed-3/", basename(current))
#                     copyfile(src,dst)
#                 except:
#                     print sys.exc_info()

# infiletabletestAG = "HTML/eval2/kasuskhusus/mixedheader.html"
# infilefeaturetestAG = "Features/kasuskhusus/mixedheader.txt"
# de = DataExtractor()
# de.extract_table(infiletabletestAG,infilefeaturetestAG)

# infiletabletestAG = "HTML/eval2/kasuskhusus/topoatheader.html"
# infilefeaturetestAG = "Features/kasuskhusus/topoatheader.txt"
# extract_table(infiletabletestAG,infilefeaturetestAG)

# infiletabletestAG = "HTML/eval2/kasuskhusus/topomorethanone.html"
# infilefeaturetestAG = "Features/kasuskhusus/topomorethanone.txt"
# extract_table(infiletabletestAG,infilefeaturetestAG)

infiletabletestAG = "13/13.html0-13.html"
infilefeaturetestAG = "Features/kasuskhusus/levelgroup.txt"
de = DataExtractor()
de.extract_table(infiletabletestAG,infilefeaturetestAG)