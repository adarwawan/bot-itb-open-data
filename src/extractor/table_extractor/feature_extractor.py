...
class RowFeatureExtractor(object):
    ...
    def setArrayOfAttr(self, row_soup):
        ...
        B = self.countB(cells)
        row_features = str(AisMerged) + "," + str(AisHead) + "," + str(AisEmpty) + "," + str(AisShortText) + "," + str(AisLongText) + "," + str(AisNumeric) + "," + str(B) + "\n"
...
# input_dir = "clean_html/13/"
# output_dir = "row_feature_extraction/13/"
